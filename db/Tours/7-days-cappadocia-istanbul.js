const _7DaysCappadociaIstanbul = [
  // Content
  [
    [
      {
        ...
        Content:
          "Discover the best of Turkey on this 7-day journey that combines Cappadocia and Istanbul. Stay in our own luxury hotel in Cappadocia with fairy-chimney and hot air balloon views. Enjoy guided tours of the Göreme Open-Air Museum, take a local pottery lesson in Avanos, and savor the regional cuisine in a Turkish Dance Show. Then, fly off to Istanbul where you will rest in luxury accommodations in Old City. Enjoy guided tours of the Bosphorus, Sultan Ahmet, Topkapi Palace, Hagia Sophia and much more. Fall in love with Turkey’s culture and beauty on this tour.",
      },
    ],
    ...
    [
      ...
      {
        id: 4,
        title: "Day 4: Cappadocia & Istanbul",
        list: [
          "Enjoy breakfast at your hotel",
          "Get on a VIP transfer from your hotel to Cappadocia airport",
          "Take a domestic flight from Cappadocia to Istanbul",
    ...
    [
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/1.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/2.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/3.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/4.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/5.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/6.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/7.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/8.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/9.webp",
      "/img/tours/carousel//7-DAYS-CAPPADOCIA-ISTANBUL/10.webp",
    ],
  ],
  //   Price
  [
  ...
  [
    ...
    {
      content:
        "The accommodations are charming and cozy, and the staff's hospitality is heartwarming. Ms. Makbule operates the hotel in Cappadocia, so she gave me extra attention - anything I needed from juice, water, to coffee (even outside breakfast hours) was provided. Our guided tours were also very fun. The hot air balloon experience is simply magical - I recommend everyone to try it at least once in their life. Istanbul didn’t fall short either. I landed and the driver was waiting with my name card and took me straight to my hotel in the old city. The hotel was also super close to all the main spots. I can’t rate this tour enough and will come back to Turkey again!",
      footer: "Sarah · November 2023",
    },
    {
      content:
        "If you are thinking about Turkey for a holiday destination just do it. You won't be sorry, it's a beautiful and amazing country rich in history. This is my 3rd time coming to Turkey and it was my best trip yet. A lot better when experts like Makbule and Seckin design my trip.",
      footer: "Antonio · October 2023",
    },
    {
      content:
        "Every detail of this trip was pure perfection. The accommodations, particularly Mak's Cave House in Cappadocia, was amazing. Breakfast was the best I ever had in any country. The hot air balloon ride with the sunrise was surreal. Istanbul's energy left me with unforgettable memories. Our guides in both cities were all very cheerful and our groups were very energetic. The Bosphorus tour literally left me speechless. I can't thank Makbule and her team enough for this adventure.",
